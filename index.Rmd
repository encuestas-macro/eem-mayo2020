...
<!-- Redancción -->
<div class="left">
Las expectativas de inflación para el 2020 se corrigen a la baja en la medición de mayo, con promedio de 2.71% y mediana de 2.5%. Se identifica una considerable reducción en la dispersión de las expectativas, denotando reducción de la incertidumbre de los analistas. Con este resultado, las expectativas de inflación para el 2020 se desvían por primera vez del rango de meta de 4% +/- 1%.

Hacia el año próximo, el promedio de las expectativas de inflación interanual para mayo se mantiene por debajo del rango de meta (2.72%), pero se recupera y colocan en 3.81% para el cierre del 2021.
</div>
...
De igual forma, para el final del 2021 y a mayo del 2022 la depreciación interanual esperada del tipo de cambio rondaría el 5%, al colocar sus expectativas en 4.8% y 5.1%, respectivamente. Estos resultados confirman la confianza de los analistas en que se reduzcan las presiones alcistas del tipo de cambio y este retorne gradualmente a sus niveles pre-pandemia.
</div>
...
<div class="left">
Las expectativas de crecimiento para el año 2020 se han deteriorado en los últimos meses. En la encuesta de mayo la mediana de las expectativas de crecimiento para el año actual se coloca en -2.0%, con un mínimo de -3.6% y un máximo de 0.5%. 
...
En las últimas dos ediciones de la encuesta se han incluido preguntas con la finalidad de captar las expectativas de los analistas respecto a la desviación de variables macroeconómicas importantes ante el choque generado por la pandemia del COVID19.
